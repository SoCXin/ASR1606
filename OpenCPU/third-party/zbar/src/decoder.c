...
#if (defined ENABLE_I25) || (defined ENABLE_CODABAR) || (defined ENABLE_CODE39) || (defined ENABLE_CODE93) || (defined ENABLE_CODE128) || (defined ENABLE_PDF417)
    return(0);
#endif
}
